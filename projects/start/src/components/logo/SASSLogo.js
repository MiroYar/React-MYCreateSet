        ...
        <a href="https://sass-lang.com/" target="_blank" title="SASS">
            ...
            >
                <path
                    ...
                    clipRule="evenodd"
                    fill="#CC6699"
                    d="M305.4,191c113.5,0,205.4,92,205.4,205.4c0,113.5-92,205.4-205.4,205.4c-113.5,0-205.4-92-205.4-205.4
                    C100,283,192,191,305.4,191L305.4,191z"
                />
                <g>
                    <path
                        fill="#ffffff"
                        d="M434.3,278.9c-9.3-36.5-69.8-48.5-127.1-28.1c-34.1,12.1-71,31.1-97.5,55.9c-31.5,29.5-36.6,55.2-34.5,65.9
